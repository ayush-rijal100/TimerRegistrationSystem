...
import type { HarnessContext } from "../agent/contextBuilder.js";
import type {
...
import type { CorrectionMemory } from "../memory/correctionMemory.js";
import type { RetrievedKnowledge } from "../rag/ragRetriever.js";
import type { SafetyResult } from "../safety/safetyPolicy.js";
import type { PendingAction } from "../state/pendingActionStore.js";
import type { AssignmentResolveResult } from "../resolvers/assignmentResolver.js";
import type { EmployeeReportMatch } from "../skills/reportSkill.js";
import type { ManagerInsight, ManagerRecommendations } from "../skills/insightSkill.js";
import type { RecommendationMemory } from "../memory/recommendationMemory.js";
import type { ToolVerificationFailure } from "../verification/toolResultVerifier.js";
import type { ToolRegistryEntry } from "../tools/toolRegistry.js";


export function formatWhoAmIPlaceholder(context: HarnessContext): string {
  return [
...
export function formatCurrentUserResponse(user: CurrentUserResponse): string {
  return [
...
export function formatContextSummary(context: HarnessContext): string {
  return [
    ...
    ...(
      context.correctionMemories.length > 0
        ? context.correctionMemories.map((correction, index) =>
...
export function formatMyProjectsResponse(projects: ProjectResponse[]): string {
...
export function formatAdminProjectsResponse(projects: ProjectResponse[]): string {
  if (projects.length === 0) {
...
export function formatAdminUsersResponse(users: UserResponse[]): string {
  if (users.length === 0) {
...
export function formatProjectAssignmentsResponse(
  ...
  const rows = assignments.map((assignment) => {
    ...
    const project =
      assignment.projectName.length > 32
...
export function formatSafetyRejection(safetyResult: SafetyResult): string {
  return [
...
export function formatCreateProjectDraft(action: PendingAction): string {
...
export function formatCreateProjectMissingFields(): string {
  return [
...
export function formatAssignUserToProjectDraft(action: PendingAction): string {
...
export function formatAssignUserToProjectMissingFields(): string {
  return [
...
export function formatAssignmentResolveProblem(
  result: Exclude<AssignmentResolveResult, { status: "RESOLVED" }>
): string {
...
export function formatAssignmentAlreadyExists(
  assignment: UserProjectAssignmentResponse
): string {
...
export function formatPendingActionCancelled(action: PendingAction): string {
  if (action.type === "CREATE_PROJECT") {
    return [
...
export function formatCreateProjectSuccess(project: ProjectResponse): string {
  return [
...
export function formatAssignUserToProjectSuccess(
  response: AssignUserProjectResponse
): string {
  return [
...
export function formatCorrectionSaved(correction: CorrectionMemory): string {
  return [
...
export function formatCorrectionList(corrections: CorrectionMemory[]): string {
...
export function formatCorrectionMissingText(): string {
  return [
...
export function formatMissingEntriesReportResponse(
...
export function formatSingleEmployeeMissingEntriesResponse(
  employee: MissingEntriesReportResponse,
  label: string
): string {
...
export function formatMissingEntriesEmployeeMatchProblem(
  match: Exclude<EmployeeReportMatch, { status: "NO_REFERENCE" | "MATCHED" }>,
  label: string
): string {
...
function wrapList(values: string[], chunkSize: number): string[] {
  const chunks: string[] = [];
...
export function formatMissingEntriesMissingDateRange(): string {
  return [
...
export function formatUtilizationReportResponse(
...
export function formatSingleEmployeeUtilizationResponse(
  employee: UtilizationReportResponse,
  label: string
): string {
  return [
...
export function formatUtilizationEmployeeMatchProblem(
  match: Exclude<EmployeeReportMatch<UtilizationReportResponse>, { status: "NO_REFERENCE" | "MATCHED" }>,
  label: string
): string {
  if (match.status === "NOT_FOUND") {
    return [
...
export function formatUtilizationMissingDateRange(): string {
  return [
...
function formatUtilizationRow(item: UtilizationReportResponse): string {
  const name = item.fullName.length > 18
    ? `${item.fullName.slice(0, 15)}...`
    : item.fullName.padEnd(18);
...
export function formatManagerInsightResponse(
...
export function formatManagerRecommendationsResponse(
...
export function formatManagerRecommendationsMissingDateRange(): string {
  return [
...
export function formatRecommendationMemorySaved(memory: RecommendationMemory): string {
  return [
...
export function formatRecommendationMemoryList(
...
export function formatRecommendationMemoryMissingText(): string {
  return [
...
export function formatRegisteredToolsResponse(
...
export function formatUnsupportedResponse(userMessage: string): string {
  return [
...
export function formatToolVerificationError(
  verification: ToolVerificationFailure
): string {
  return [
