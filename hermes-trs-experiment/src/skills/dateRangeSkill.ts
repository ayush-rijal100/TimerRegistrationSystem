...
export function extractDateRange(userMessage: string, today = new Date()): DateRangeDraft | null {
...
function findExplicitMonth(message: string, defaultYear: number): DateRangeDraft | null {
...
function monthRange(year: number, month: number): DateRangeDraft {
