...
exports.checkUserMessageSafety = checkUserMessageSafety;
const blockRules = [
    {
        ...
        explanation: "Requests to reveal system prompts or hidden instructions are not allowed."
    },
    {
        ...
        explanation: "Requests to reveal secrets, tokens, API keys, or database credentials are not allowed."
    },
    {
        ...
        explanation: "Requests that try to override the harness instructions or safety rules are not allowed."
    },
    {
        ...
        explanation: "Role claims must come from the TRS backend identity mapping, not from user text."
    },
    {
        ...
        explanation: "The Spring Boot backend must remain the authority for authorization and business rules."
    },
    {
        ...
        explanation: "The harness must not perform direct database writes or destructive SQL operations."
    }
];
function findBlockedRule(userMessage) {
...
function checkUserMessageSafety(userMessage) {
